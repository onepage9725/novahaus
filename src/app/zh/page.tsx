    ...
    <main className="bg-white text-gray-800 antialiased font-sans">
      ...
      <section className="py-20 px-8 lg:px-24 bg-[#ead7c7]">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 h-64">
              ...
              <img src="/images/about2.jpg" className="w-full h-full object-cover rounded-xl mt-8" alt="Property" />
              <img src="/images/about3.jpg" className="w-full h-full object-cover rounded-xl -mt-8" alt="Property" />
