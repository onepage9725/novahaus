...
export interface IconGridItem {
  ...
  href?: string; // Added to make items clickable
}
      ...
      >
        {items.map((item) => {
          ...
          return (
            ...
            >
              <div className="flex h-16 w-16 items-center justify-center rounded-lg border border-white/20 bg-white/5 p-4 transition-all duration-300 ease-in-out hover:bg-white/10 hover:shadow-lg hover:-translate-y-1">
                {item.icon}
              </div>
            </Tag>
          );
